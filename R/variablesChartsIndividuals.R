...
variablesChartsIndividuals <- function(jaspResults, dataset, options) {
  ...
  if (options$ImRchart && ready) {
    if(is.null(jaspResults[["Ichart"]])){
      ...
      jaspResults[["Ichart"]]$dependOn(c("ImRchart", "variables", "ncol", "subgroups", "manualTicksXAxis", "manualTicksXAxisValue", "ccTitle", "ccName", "ccMisc","ccReportedBy","ccDate", "ccSubTitle", "ccChartName", "ccReport"))
  ...
  if (options[["variableChartIndividualsReport"]] && is.null(jaspResults[["CCReport"]])) {
    ...
    jaspResults[["CCReport"]]$dependOn(c("CCReport", "ImRchart", "variables","ncol", "manualTicksXAxis", "manualTicksXAxisValue", "subgroups", "ccTitle", "ccName", "ccMisc","ccReportedBy","ccDate", "ccSubTitle", "ccChartName"))
