	...
	Section
	{
		...
		Group
		{
			...
			CheckBox
			{
				name: 								"rule4"
				label: 								""
				checked:							testSet.currentValue != "jaspDefault" | controlChartType.currentValue == "xmr"
				enabled:							testSet.currentValue == "custom"
				childrenOnSameRow:					true
			...
			CheckBox
			{
				name: 								"rule5"
				label: 								""
				checked:							testSet.currentValue == "nelsonLaws" | testSet.currentValue == "custom" | (testSet.currentValue == "jaspDefault" & controlChartType.currentValue == "xmr")
				enabled:							testSet.currentValue == "custom"
				childrenOnSameRow:					true
